...
#define MODEDEVICE "/dev/ttyHS0"  // ttyHS0, ttyHS1, ttyHS3 are available
...
void CarControlInit(void)
{
  ...
  printf("CarControlInit() Uart Device : %s\n", MODEDEVICE);
...
void SpeedControlOnOff_Write(char status)
{
        ...
        printf("SpeedControlOnOff_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

signed short DesireSpeed_Read()
{
        buf[0] = 0x91;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void DesireSpeed_Write(signed short speed)
{
        ...
        printf("DesireSpeed_Write() = %d\n", speed);
        write(uart_fd, &buf[0], 6);
}

unsigned char SpeedPIDProportional_Read()
{
        buf[0] = 0x92;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void SpeedPIDProportional_Write(unsigned char gain)
{
        ...
        printf("SpeedPIDProportional_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

unsigned char SpeedPIDIntegral_Read()
{
        buf[0] = 0x93;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void SpeedPIDIntegral_Write(unsigned char gain)
{
        ...
        printf("SpeedPIDIntegral_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

unsigned char SpeedPIDDifferential_Read()
{
        buf[0] = 0x94;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void SpeedPIDDifferential_Write(unsigned char gain)
{
        ...
        printf("SpeedPIDDifferential_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

char PositionControlOnOff_Read()
{
        buf[0] = 0x96;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void PositionControlOnOff_Write(char status)
{
        ...
        printf("PositionControlOnOff_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

unsigned char PositionProportionPoint_Read()
{
        buf[0] = 0x98;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void PositionProportionPoint_Write(unsigned char gain)
{
        ...
        printf("PositionProportionPoint_Write() = %d\n", buf[3]);
        write(uart_fd, &buf[0], 5);
}

signed int DesireEncoderCount_Read()
{
        buf[0] = 0x97;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
//      printf("Read Desire position\n");
        ...
        return ((signed int)(read_buf[5]<<24) + (signed int)(read_buf[4]<<16) +
(signed int)(read_buf[3]<<8) + (signed int)(read_buf[2]));
}
...
void DesireEncoderCount_Write(signed int position)
{
        ...
        printf("DesireEncoderCount_Write() = %d\n", position);
        write(uart_fd, &buf[0], 8);
}

signed int EncoderCounter_Read()
{
        buf[0] = 0xb0;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void EncoderCounter_Write(signed int position)
{
        ...
        printf("EncoderCounter_Write() = %d\n", position);
        write(uart_fd, &buf[0], 8);
}

signed short SteeringServoControl_Read()
{
        buf[0] = 0xa3;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void SteeringServoControl_Write(signed short angle)
{
        ...
        printf("SteeringServoControl_Write() = %d\n", angle);
        write(uart_fd, &buf[0], 6);
}

signed short CameraXServoControl_Read()
{
        buf[0] = 0xa5;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void CameraXServoControl_Write(signed short angle)
{
        ...
        printf("CameraXServoControl_Write() = %d\n", angle);
        write(uart_fd, &buf[0], 6);
}

signed short CameraYServoControl_Read()
{
        buf[0] = 0xa7;
        buf[1] = 0x02; //code length (0) + 2
        buf[2] = 0x02; //read(2)
...
void CameraYServoControl_Write(signed short angle)
{
        ...
        printf("CameraYServoControl_Write() = %d\n", angle);
        write(uart_fd, &buf[0], 6);
}
